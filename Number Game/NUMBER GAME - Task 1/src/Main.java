    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (guessnum > orgnum) {
                    System.out.println("The guessed number is more than the original number");
                } else if (guessnum < orgnum) {
                    System.out.println("The guessed number is less than the original number");
                } else {
